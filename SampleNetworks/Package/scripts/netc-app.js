...
var TEMPLATEPATH = './app/assets/templates/';
var DB_CLONEMASTER = "blank.loki";
var NC_CONFIG = require("../assets/netcreate-config");
...
DB.InitializeDatabase = function () {
  ...
  var db_file = m_GetValidDBFilePath(dataset);
  ...
  function f_DatabaseInitialize() {
    ...
    // LOAD TEMPLATE  - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    var templatePath = RUNTIMEPATH + NC_CONFIG.dataset + ".template";
...
DB.PKT_GetDatabase = function (pkt) {
  ...
  return { d3data: { nodes: nodes, edges: edges }, template: TEMPLATE };
};
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
DB.WriteDbJSON = function (filePath) {
  ...
  var db_file = m_options ? m_options.db_file : m_GetValidDBFilePath(dataset);
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Button,
                  { outline: true, size: 'sm', className: 'float-right',
                    hidden: !(this.state.isEditable && this.state.hasValidTarget && (targetNode.label !== this.props.parentNodeLabel || sameSourceAndTarget)),
...
var InfoPanel = function (_UNISYS$Component) {
  ...
  _createClass(InfoPanel, [{
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('1');_this2.sendGA('Graph', window.location);
                  }
                },
                'Graph'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('2');_this2.sendGA('Nodes Table', window.location);
                  }
                },
                'Nodes Table'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('3');_this2.sendGA('Edges Table', window.location);
                  }
                },
                'Edges Table'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('4');_this2.sendGA('Vocabulary', window.location);
                  }
                },
                'Vocabulary'
              )
            ...
            React.createElement(
              ...
              React.createElement(
                NavLink,
                {
                  ...
                  onClick: function onClick() {
                    _this2.toggle('5');_this2.sendGA('Help', window.location);
                  }
                },
                'Help'
              )
    ...
    key: 'sendGA',
    value: function sendGA(actionType, url) {
...
var NetGraph = function (_UNISYS$Component) {
  ...
  _createClass(NetGraph, [{
    ...
    key: 'render',
    value: function render() {
      var nodeTypes = this.AppState('TEMPLATE').nodePrompts.type.options;
      return React.createElement(
        'div',
        { style: { height: '100%' } },
        React.createElement(
        ...
        React.createElement(
          'div',
          { style: { position: 'absolute', bottom: '40px', marginLeft: '10px', marginBottom: '15px', fontSize: '10px' } },
          React.createElement(
            'div',
          ...
          nodeTypes.map(function (type, i) {
            return React.createElement(
              'div',
              { key: i, title: type.help != undefined ? type.help : type.label, style: { display: 'inline-block', paddingRight: '2em', lineHeight: '10px' } },
              '                ',
              React.createElement('div', { style: { display: 'inline-block', width: '10px', height: '8px', backgroundColor: type.color } }),
              '\xA0',
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /*//////////////////////////////// ABOUT \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*\
...
var NodeSelector = function (_UNISYS$Component) {
  ...
  function NodeSelector(props) {
    ...
    UDATA.HandleMessage("NODE_EDIT", function (data) {
      if (data.nodeID !== undefined && typeof data.nodeID === "number" && !_this.state.isEditable) {
  ...
  _createClass(NodeSelector, [{
    ...
    value: function markdownDisplay(text) {
      ...
      if (!this.state.isEditable) return (0, _markdownReactJs.mdReact)({ onIterate: this.markdownIterate, markdownOptions: { typographer: true }
      })(text);
    }
  }, {
    key: 'markdownIterate',
            ...
            this.state.nodes.map(function (node, i) {
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(_markdownReactJs2.default, { text: node.attributes["Notes"], onIterate: _this2.markdownIterate, markdownOptions: { typographer: true } })
                )
              );
            })
          )
...
MOD.Hook("LOADASSETS", function () {
  if (UNISYS.IsStandaloneMode()) {
    ...
    var _p = DATASTORE.PromiseJSONFile("data/" + dataset + "-db.json").then(function (data) {
      m_ConvertData(data);
    ...
    // load template
    var p2 = DATASTORE.PromiseJSONFile("data/" + dataset + "-template.json").then(function (data) {
      TEMPLATE = data;
      UDATA.SetAppState("TEMPLATE", TEMPLATE);
    });
    return Promise.all([_p, p2]);
  }
  // if got this far...
